...
$ZipPath      = Join-Path $env:TEMP "AutoCAD_2021_Shell_YJ.zip"  # C盘%temp%下载
$FinalDir     = "D:\AutoCAD_2021_Shell_YJ"                      # D盘固定解压目录
